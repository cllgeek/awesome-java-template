package com.geekjc.server.config.security.service.impl;
...
public class UserDetailsServiceImpl implements UserDetailsService {
     ...
     *
     * @param token:
     * @return: com.geekjc.server.config.security.dto.SecurityUser
     */
    ...
    private List<Role> getUserRoles(Integer userId) {
        List<UserRole> userRoles = userRoleMapper.selectList(new QueryWrapper<UserRole>().eq("user_id", userId)); // 相当于SQL语句: select * from UserRole where user_id = userId;
