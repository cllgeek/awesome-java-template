...
import com.geekjc.server.modules.common.validator.Create;
import com.geekjc.server.modules.common.validator.FieldRepeatValidator;
import com.geekjc.server.modules.common.validator.Update;
...
//	@FieldRepeatValidator(className = "com.geekjc.server.modules.system.entity.User", field = "pwd", message = "密码重复！")
//	@FieldRepeatValidator(className = "com.geekjc.server.modules.system.entity.User", field = "pwd", message = "密码重复！",groups={FieldRepeatValidator.class})
    private String pwd;
    /**
     * 昵称
     */
