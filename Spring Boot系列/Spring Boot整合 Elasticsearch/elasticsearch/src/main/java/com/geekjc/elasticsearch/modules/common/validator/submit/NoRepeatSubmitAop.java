package com.geekjc.elasticsearch.modules.common.validator.submit;

import com.geekjc.elasticsearch.config.Constants;
import com.geekjc.elasticsearch.modules.common.dto.output.ApiResult;
import com.geekjc.elasticsearch.utils.IpUtils;
import com.geekjc.elasticsearch.utils.RedisUtil;
...
public class NoRepeatSubmitAop {
     ...
     *
     *      com.geekjc.elasticsearch.modules.*.api ： 标识AOP所切服务的包名，即需要进行横切的业务类
     ...
     */
    @Around("execution(* com.geekjc.elasticsearch.modules.*.api.*Controller.*(..)) && @annotation(noRepeatSubmit)")
