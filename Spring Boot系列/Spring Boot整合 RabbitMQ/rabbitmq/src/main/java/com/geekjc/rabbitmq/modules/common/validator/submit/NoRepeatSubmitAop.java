package com.geekjc.rabbitmq.modules.common.validator.submit;

import com.geekjc.rabbitmq.config.Constants;
import com.geekjc.rabbitmq.modules.common.dto.output.ApiResult;
import com.geekjc.rabbitmq.utils.IpUtils;
import com.geekjc.rabbitmq.utils.RedisUtil;
...
public class NoRepeatSubmitAop {
     ...
     *
     *      com.geekjc.rabbitmq.modules.*.api ： 标识AOP所切服务的包名，即需要进行横切的业务类
     ...
     */
    @Around("execution(* com.geekjc.rabbitmq.modules.*.api.*Controller.*(..)) && @annotation(noRepeatSubmit)")
