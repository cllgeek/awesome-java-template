package com.geekjc.resubmit.modules.common.validator;

import com.geekjc.resubmit.config.Constants;
import com.geekjc.resubmit.modules.common.dto.output.ApiResult;
import com.geekjc.resubmit.utils.IpUtils;
import com.geekjc.resubmit.utils.RedisUtil;
...
public class NoRepeatSubmitAop {
     ...
     *
     *      com.geekjc.resubmit.modules.*.api ： 标识AOP所切服务的包名，即需要进行横切的业务类
     ...
     */
    @Around("execution(* com.geekjc.resubmit.modules.*.api.*Controller.*(..)) && @annotation(noRepeatSubmit)")
